...
; BUGFIX: Rows that have 3 trashcan entries were sampled incorrectly.
; The sampling divides the range 0-255 into thirds, but the original
; code returned the result in register b instead of a.  The caller
; reads from a, so the offset was the raw random value (0-255)
; instead of the intended [0,1,2].  Fixed by returning in a.
	db 4
	db  1,3,   3,1,   1,-1,  3,-1
	db 3
	db  0,2,   2,4,   4,0,  -1,-1
